...
def decode_json(json_floder_path, json_name, label):
    txt_name = r'E:\file\Code\Python\datasets\cigarette\labels/' + json_name[0:-5] + '.txt'  # 生成txt文件你想存放的路径
...
if __name__ == "__main__":
    json_floder_path = r'E:\file\Code\Python\datasets\error'  # json文件的路径
